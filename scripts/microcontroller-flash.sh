...
restart_repl() {
  ...
  elif [[ -x "$HOME/nixCore/scripts/microcontroller-connect.sh" ]]; then
    script="$HOME/nixCore/scripts/microcontroller-connect.sh"
  else
    die "microcontroller-connect.sh not found (checked PATH and ~/nixCore/scripts/)"
  fi
